<script lang="ts">
	const {
		...
		description = 'The River is a rising HipHop/R&B artist based in Denver, Colorado. She is a multi-faceted individual who was a marching band nerd and later explored dance, multimedia arts, and songwriting.'
	} = $props();
</script>
															...
															<td align="center" valign="top">
																<table
																	...
																	<tbody>
																		<tr>
																			<td
																				class="pc-w620-spacing-0-0-10-0"
																				valign="top"
																					...
																					<tbody>
																						<tr>
																							<td
																								...
																								align="center">
																								<div
																									class="pc-font-alt pc-w620-fontSize-33px pc-w620-lineHeight-120pc"
																									style="line-height: 120%; letter-spacing: -0px; font-family: 'Poppins', Arial, Helvetica, sans-serif; font-size: 36px; font-weight: 600; font-variant-ligatures: normal; color: #ffffff; text-align: center; text-align-last: center; text-transform: uppercase;">
																									<div>
																										<span style="color: rgb(0, 255, 131);">
																											{title}
																										</span>
																					...
																					<tbody>
																						<tr>
																							<td
																								...
																								align="center">
																								<div
																									class="pc-font-alt pc-w620-fontSize-17px pc-w620-lineHeight-133pc"
