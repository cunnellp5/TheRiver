								...
								<td class="pc-w620-spacing-0-0-32-0" style="padding: 0px 0px 40px 0px;">
									<table
										...
										<tr class="pc-grid-tr-first pc-grid-tr-last">
											<td
												class="pc-grid-td-first pc-w620-itemsSpacings-0-24"
												align="left"
												valign="middle"
																			...
																			<tr>
																				<td align="left" valign="top">
																					<a
																						...
																						<img
																							src="https://api-postcards.designmodo.com/files/images/user-428/image-17229390160148.jpg"
																							class=""
																							width="327"
																							height="auto"
																							alt=""
											...
											<td
												class="pc-grid-td-last pc-w620-itemsSpacings-0-24"
												align="left"
												valign="middle"
																						...
																						<tr>
																							<td valign="top" align="left">
																								<div
																									...
																									<div>
																										<span>The New Voice of Modern Jazz</span>
																									</div>
																								</div>
																							</td>
																						</tr>
																						...
																						<tr>
																							<td valign="top" align="left">
																								<div
																									...
																									<div>
																										<span>
																											Dive into the rich, soulful melodies of
																										</span>
																										<span
																										...
																										<span>
																											, where classic jazz meets contemporary flair.
																										</span>
																									</div>
																								</div>
																							</td>
									...
									<table
										...
										<tr class="pc-grid-tr-first pc-grid-tr-last">
											<td
												...
												align="left"
												valign="middle"
												style="width: 50%; padding-top: 0px; padding-right: 0px; padding-bottom: 0px; padding-left: 20px; direction: ltr;"
												dir="ltr">
												<table
													width="100%"
													border="0"
													...
													<tr>
														<td
															class="pc-w620-halign-left pc-w620-valign-top"
															align="left"
															valign="middle">
															<table
																			...
																			<tr>
																				<td class="pc-w620-halign-left" align="left" valign="top">
																					<a
																						...
																						style="text-decoration: none;">
																						<img
																							src="https://api-postcards.designmodo.com/files/images/user-428/image-17229390160749.jpg"
																							class="pc-w620-width-100pc pc-w620-height-auto pc-w620-halign-left"
																							width="240"
																							height="240"
																							alt=""
																							style="display: block; outline: 0; line-height: 100%; -ms-interpolation-mode: bicubic; width:240px; height: auto; max-width: 100%; border: 0;" />
																					</a>
																				</td>
																			</tr>
																		</table>
											...
											<td
												...
												align="left"
												valign="middle"
												style="width: 50%; padding-top: 0px; padding-right: 20px; padding-bottom: 0px; padding-left: 0px; direction: ltr;"
												dir="ltr">
												<table
													width="100%"
													border="0"
																						...
																						<tr>
																							<td valign="top" align="left">
																								<div
																									...
																									style="line-height: 120%; letter-spacing: 0px; font-family: 'Poppins', Arial, Helvetica, sans-serif; font-size: 32px; font-weight: 600; font-variant-ligatures: normal; color: #ffffff; text-align: left; text-align-last: left;">
																									<div>
																										<span>RnB-Soul&amp;#39;s Rising Star</span>
																									</div>
																								</div>
																							</td>
																						</tr>
																						...
																						<tr>
																							<td valign="top" align="left">
																								<div
																									...
																									<div>
																										<span>
																											Experience the deep emotions and smooth
																											grooves that make
																										</span>
																										<span
																											style="font-weight: 700;font-style: normal;">
																										...
																										<span>
																											a name to remember in the world of RnB-Soul.
																										</span>
																									</div>
																								</div>
																							</td>
