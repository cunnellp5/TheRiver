<svelte:head>
  ...
  <link
    ...
    rel="stylesheet" />
  <link
    href="https://fonts.googleapis.com/css?family=Raleway:ital,wght@0,600"
    rel="stylesheet" />
  ...
  <style>
    @media (max-width: 620px) {
      ...
      table.pc-w620-spacing-1-0-0-0 {
        margin: 1px 0px 0px 0px !important;
      }
      td.pc-w620-spacing-1-0-0-0,
      th.pc-w620-spacing-1-0-0-0 {
        margin: 0 !important;
      ...
      table.pc-w620-spacing-135-0-0-0 {
        margin: 135px 0px 0px 0px !important;
      }
      td.pc-w620-spacing-135-0-0-0,
      th.pc-w620-spacing-135-0-0-0 {
        margin: 0 !important;
        padding: 135px 0px 0px 0px !important;
      }
      .pc-w620-fontSize-35px {
  ...
  <style>
    @media all {
      @font-face {
        ...
        font-weight: 600;
        src:
          url("https://fonts.gstatic.com/s/poppins/v21/pxiByp8kv8JHgFVrLEj6Z1JlEw.woff")
            format("woff"),
      ...
      @font-face {
        ...
        font-weight: 500;
        src:
          url("https://fonts.gstatic.com/s/poppins/v21/pxiByp8kv8JHgFVrLGT9Z1JlEw.woff")
            format("woff"),
      ...
      @font-face {
        ...
        font-weight: 700;
        src:
          url("https://fonts.gstatic.com/s/poppins/v21/pxiByp8kv8JHgFVrLCz7Z1JlEw.woff")
            format("woff"),
      ...
      @font-face {
        ...
        font-weight: 600;
        src:
          url("https://fonts.gstatic.com/s/raleway/v29/1Ptxg8zYS_SKggPN4iEgvnHyvveLxVsEpbCGPrc.woff")
            format("woff"),
          url("https://fonts.gstatic.com/s/raleway/v29/1Ptxg8zYS_SKggPN4iEgvnHyvveLxVsEpbCGPrE.woff2")
            format("woff2");
        font-family: "Raleway";
      }
    }
