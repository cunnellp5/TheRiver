						...
						<table width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation">
							<tr>
								<td
									...
									<table
										class="pc-width-fill pc-w620-gridCollapsed-0 pc-w620-width-fill pc-w620-halign-center"
										width="100%"
										border="0"
										cellpadding="0"
										cellspacing="0"
										...
										<tr class="pc-grid-tr-first pc-grid-tr-last">
											<td
												class="pc-grid-td-first pc-w620-itemsSpacings-0-40"
												align="right"
												valign="bottom"
												style="width: 50%; padding-top: 0px; padding-right: 80px; padding-bottom: 0px; padding-left: 0px;">
												<table
													width="100%"
													border="0"
													cellpadding="0"
																			...
																			<tr>
																				<td
																					...
																					<img
																						...
																						class="pc-w620-width-100 pc-w620-height-auto pc-w620-align-left"
																						width="120"
																						height="53"
																						alt=""
																		...
																		<table
																			...
																			<tr>
																				<td
																					...
																					align="left">
																					<table
																						class="pc-width-hug pc-w620-gridCollapsed-0 pc-w620-halign-left"
																						align="left"
																						border="0"
																						cellpadding="0"
																						cellspacing="0"
																						...
																						<tr class="pc-grid-tr-first pc-grid-tr-last">
																							<td
																								class="pc-grid-td-first pc-w620-itemsSpacings-16-0"
																								valign="middle"
																															...
																															<tr>
																																<td valign="top">
																																	<a
																																		...
																																		<img
																																			src="https://api-postcards.designmodo.com/images/temp/20e91cbdbff647118aface779dadf4ad.png"
																																			class=""
																																			width="20"
																																			height="20"
																							...
																							<td
																								class="pc-w620-itemsSpacings-16-0"
																								valign="middle"
																															...
																															<tr>
																																<td valign="top">
																																	<a
																																		...
																																		style="text-decoration: none; color: #ffffff;">
																																		<img
																																			src="https://api-postcards.designmodo.com/images/temp/9586dca9d010e39343776919fc1220d8.png"
																																			class=""
																																			width="22"
																																			height="22"
																																			style="display: block; border: 0; outline: 0; line-height: 100%; -ms-interpolation-mode: bicubic; width:22px; height:22px;"
																																			alt="twitter icon" />
																																	</a>
																																</td>
																															</tr>
																															...
																															<tr>
																																<td valign="top">
																																	<a
																																		...
																																		style="text-decoration: none; color: #ffffff;">
																																		<img
																																			src="https://api-postcards.designmodo.com/images/temp/67383282fc6e96758be7bca7579bdc10.png"
																																			class=""
																																			width="20"
																																			height="20"
																																			style="display: block; border: 0; outline: 0; line-height: 100%; -ms-interpolation-mode: bicubic; width:20px; height:20px;"
																													...
																													<td
																														...
																														<table
																															...
																															<tr>
																																<td valign="top">
																																	<img
																																		src="https://api-postcards.designmodo.com/images/temp/67aad6c49ebc89b3cc144d35503961f8.png"
																																		class=""
																																		width="20"
																																		height="20"
																																		style="display: block; border: 0; outline: 0; line-height: 100%; -ms-interpolation-mode: bicubic; width:20px; height:20px;"
																							...
																							<td
																								class="pc-grid-td-last pc-w620-itemsSpacings-16-0"
																								valign="middle"
																															...
																															<tr>
																																<td valign="top">
																																	<a
																																		...
																																		style="text-decoration: none; color: #ffffff;">
																																		<img
																																			src="https://api-postcards.designmodo.com/images/temp/2c02b651893cfff58b96e931472c36ae.png"
																																			class=""
																																			width="20"
																																			height="20"
																																			style="display: block; border: 0; outline: 0; line-height: 100%; -ms-interpolation-mode: bicubic; width:20px; height:20px;"
											...
											<!-- <td
												class="pc-grid-td-last pc-w620-itemsSpacings-0-40"
												align="right"
												valign="bottom"
												style="width: 50%; padding-top: 0px; padding-right: 0px; padding-bottom: 0px; padding-left: 80px;">
												<table
													width="100%"
													border="0"
													cellpadding="0"
																		...
																		<table
																			...
																			<tr>
																				<td
																					...
																					<img
																						src="https://api-postcards.designmodo.com/files/images/user-428/image-172293901617411.png"
																	...
																	<td class="pc-w620-halign-right" align="right" valign="top">
																		<table
																			...
																			<tr>
																				<td class="pc-w620-halign-right" align="right" valign="top">
																					<img
																						src="https://api-postcards.designmodo.com/files/images/user-428/image-172293901617412.png"
																						class="pc-w620-align-right"
																						width="120"
																						height="35"
												...
												<div
													...
													<div>
														<span style="font-weight: 400;font-style: normal;">
															You are receiving this email because you signed up with The River 30
															W. Bayaud Ave, Denver, CO 80223
															<br /><br />
