...
<style>
  ...
  .gradientButtonsRight {
    background: linear-gradient(to right, var(--surface-3), var(--surface-1)) padding-box;
  }
  /* .gradientButtonsLeft {
    background: linear-gradient(to Left, var(--surface-3), var(--surface-1)) padding-box;
  } */
